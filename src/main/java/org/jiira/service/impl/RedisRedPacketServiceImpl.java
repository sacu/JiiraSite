...
public class RedisRedPacketServiceImpl implements RedisRedPacketService {
	...
	@Autowired
	private RedisTemplate<String, RedisTemplate<String, String>> redisTemplate = null; // RedisTemplate
	...
	public void saveUserRedPacketByRedis(Long redPacketId, Double unitAmount) {
		...
		// 获取列表操作对象
		BoundListOperations<String, RedisTemplate<String, String>> ops = redisTemplate.boundListOps(PREFIX + redPacketId);
		Long size = ops.size();
		...
		for (int i = 0; i < times; i++) {
			// 获取至多TIME_SIZE个抢红包信息
			List<RedisTemplate<String, String>> userIdList = null;
			if (i == 0) {
